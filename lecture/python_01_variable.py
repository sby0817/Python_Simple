...
# 기본 자료형(Primitive Type): 변수의 값이 그대로 저장
# - int num = 4;
# 객체 자료형(Reference Yype): 변수에 값이 위치한 "주소"가 저장
# - String nuame = "10";
...
# 9.  동적 출력
print("=" * 50)
student_num = 20233098
student_name = "Vamos"
# 출력 예: "조선대학교 20233098, Vamos 입니다."
print("조선대학교 20233098, Vamos 입니다.")  # 하드 코딩 지양
# 1. format() - Old
